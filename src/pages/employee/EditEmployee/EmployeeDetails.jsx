                        ...
                        <Col md={6}>
                            <Form.Group controlId="formGridEmployeeJobType">
                                ...
                                >
                                    ...
                                    {Array.isArray(formData.employeeJobType) && formData.employeeJobType.length > 0 ? (
                                        formData.employeeJobType.map(jobtype => (
                                            <option key={jobtype.id} value={jobtype.id}>{jobtype.job_name}</option>
                                        ))
                                    ) : (
                                        <option value="">No Employee Job Type Available</option>
                                    )}
                                </Form.Select>
                        ...
                        <Col>
                            <Form.Group controlId="formGridEmployeeCategory">
                                ...
                                >
                                    ...
                                    {formData.employeeCategory && formData.employeeCategory.length > 0 ? (
                                        formData.employeeCategory.map(supervisor => (
                                            <option key={supervisor.id} value={supervisor.id}>
                                                {supervisor.employee_category}
                                            </option>
                                        ))
                                    ) : (
                                        <option value="">No Employee Categories Available</option>
                                    )}
                                </Form.Select>
