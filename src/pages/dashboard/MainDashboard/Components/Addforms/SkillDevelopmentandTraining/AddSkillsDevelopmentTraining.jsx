...
function AddSkillsDevelopmentTraining() {
    // loading state
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                'https://office3i.com/development/api/public/api/insert_skill_dev',
                formData,
                {
                    headers: {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://office3i.com/development/api/public/api/list_skill_dev', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            });
            if (response.ok) {
                ...
                setTableData(responseData.skill_dev_list); // Access skill_dev_list from responseData
                console.log("responseData.skill_dev_list", responseData.skill_dev_list);
                setLoading(false);
            } else {
...
`}
            ...
            {loading ? (
                ...
                <Container fluid className='shift__container'>
                    <h3 className='mb-5' style={{ fontWeight: 'bold', color: '#00275c' }}>Add Skill Development & Training</h3>
...
export default AddSkillsDevelopmentTraining